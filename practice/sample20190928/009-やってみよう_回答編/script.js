...
/** ===========================================================================
 * 006 ～ 008 までの課題に、うまく対応することができたでしょうか。
 * このサンプルでは、やってみようシリーズの模範解答のコードを頂点シェーダに記載
 * しています。
 * 自分で課題を解くことができなかったとしても、最初はある意味、それは当たり前の
 * ことなので落ち込む必要はありません。このサンプルの頂点シェーダをよく観察して
 * どのような計算が、どのような表現に活用されているのか、じっくり考えて見るとよ
 * いでしょう。
 * ========================================================================= */

...
/** ===========================================================================
 * このサンプルは「やってみようシリーズ」です。
 * 現在のサンプルのソースコードは完成した状態にはなっていません。自身の手で修正
 * を行い、サンプルを完成させましょう。
 * 問題については頂点シェーダ（vs1.vert）のコメントに記載してあります。
 * ========================================================================= */
...
class WebGLFrame {
        ...
        return new Promise((resolve) => {
            ...
            .then((shaders) => {
                ...
                this.uniLocation = [
                    ...
                    gl.getUniformLocation(this.program, 'time'), // uniform 変数に経過時間を追加 @@@
                ];
                this.uniType = [
                    'uniform4fv',
                    'uniform1f', // 単体の浮動小数点の値なので 1f @@@
                ];
    ...
    setup(){
        ...
        this.position = [];       // 頂点座標
        this.ratio = [];          // 頂点が持つ定義順の割合い
        for(let i = 0; i < VERTEX_COUNT; ++i){
            // すべての頂点の座標は原点にしてしまう
            this.position.push(0.0, 0.0, 0.0);
            // 定義順の割合いは 0.0 ～ 1.0 の範囲

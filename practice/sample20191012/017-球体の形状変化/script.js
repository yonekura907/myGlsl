...
/** ===========================================================================
 * 球体状のローカル座標を定義できるようになったので、続いては JavaScript 側から
 * ２つの異なるローカル座標をシェーダへと送ってやり、シェーダ内でそれぞれの状態
 * へ座標の値が遷移する変形実装を行ってみましょう。
 * JavaScript 側では２種類のローカル座標を VBO に設定しておき、頂点シェーダ内で
 * これを補間します。
 * ========================================================================= */
    ...
    load(){
        ...
        return new Promise((resolve) => {
            ...
            .then((shaders) => {
                ...
                // attribute 変数関係
                this.attLocation = [
                    gl.getAttribLocation(this.program, 'planePosition'),  // 平面のローカル座標 @@@
                    gl.getAttribLocation(this.program, 'spherePosition'), // 球体のローカル座標 @@@
